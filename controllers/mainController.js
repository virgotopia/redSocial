app.controller("mainCtrl", function($scope) {
  ...
  var myTopPostsMenuButton = document.getElementById("menu-top-posts");
  ...
  function onAuthStateChanged(user) {
    ...
    if (user) {
      ...
      document.getElementById("menu-my-posts").style.display = "block";
      document.getElementById("newPost").style.display = "block";
      document.getElementById("login").innerHTML =
        "<i class='material-icons'>account_box</i>Logout";
    } else {
      // Set currentUID to null.
      currentUID = null;
      document.getElementById("menu-my-posts").style.display = "none";
